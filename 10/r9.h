...
class Stock
{
    ...
    // 里面放的都是接口函数
        ...
        const std::string& rcompany() const {return company;}
        long rshares() const {return shares;}
        double rshare_val() const {return share_val;}
        double rtotal_val() const {return total_val;}
};
#endif